...
contract WhitelistModule is Module {
    ...
    function setup(address[] memory accounts) public {
        setManager();
    ...
    function addToWhitelist(address account) public authorized {
        require(account != address(0), "Invalid account provided");
    ...
    /// @param account Destination address.
    function removeFromWhitelist(address account) public authorized {
