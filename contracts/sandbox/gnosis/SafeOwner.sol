...
contract SafeOwner {
    ...
    address public masterGnosisContract =
    ...
    function createProxyNoData() public {
        ...
        (bool success, bytes memory result) =
            proxyFactoryAddress.call(
                abi.encodeWithSignature(
                    functionSigCreateProxy,
                    address(testMasterSafe),
                    data
                )
            );
    ...
    function executeTransaction(address contractAddress)
        public
        returns (bool torf)
    {
        // address to,
        ...
        (bool success, bytes memory result) =
            safeAddress.call(executeTransactionData);
