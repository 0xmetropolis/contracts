...
contract Create2 is Test, SafeTeller {
    ...
    function setupSafe() public returns (address) {
        ...
        return safeTeller2.recoverSafe(addresses, threshold, 1);
    }
    ...
    function test_createSafe() public {
        ...
        // uint256 network1 = vm.createSelectFork(
        //     MAINNET_FORK_URL,
        // );
        SafeTeller mainnetTeller = new SafeTeller{
        ...
        safe1 = mainnetTeller.recoverSafe(addresses, threshold, 1);
        console.log(safe1);
    }

    function test_createSafeRinkeby() public {
        address[] memory addresses = new address[](2);
        addresses[0] = ALICE;
        addresses[1] = BOB;
        uint256 threshold = 1;

        // uint256 network2 = vm.createSelectFork(
        //     RINKEBY_FORK_URL
        // );
        vm.setNonce(msg.sender, 35);
        SafeTeller rinkebyTeller = new SafeTeller{
            salt: 0x7465737400000000000000000000000000000000000000000000000000000000
        }(
            address(gnosisSafeProxyFactory),
            address(gnosisSafe),
        ...
        safe2 = rinkebyTeller.recoverSafe(addresses, threshold, 1);
        console.log(safe2);
    }
